...
string query_name() { return "ice bolt"; }
string query_action_name() { return "Cast ice bolt"; }
int query_cost() { return 10; }
int query_violent() { return 1; }
string query_type() { return "ice"; }
int query_level() { return 0; }

int query_readiness_requirement() { return 700; }
int query_num_steps() { return 1; }
...
varargs int on_cast(mapping param) {
  ...
  wc = ([ "ice" : 3 + (check>2?2:check), "piercing" : 1 + (check>1?1:check) ]);
